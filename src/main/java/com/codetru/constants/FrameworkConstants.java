...
public final class FrameworkConstants {
    ...
    public static final String EXCEL_CICA_LOGIN = PropertiesHelpers.getValue("EXCEL_CICA_LOGIN");
    ...
    public static final String URL_CICA_ADMIN = PropertiesHelpers.getValue("URL_CICA_ADMIN");
    public static final String URL_CICA_AGENT = PropertiesHelpers.getValue("URL_CICA_AGENT");
    ...
    public static final String ICON_SOCIAL_GITHUB_PAGE_URL = "Codetru Offical GithubPage URL";
    public static final String ICON_SOCIAL_LINKEDIN_URL = "Codetru Linkedin URL";
    public static final String ICON_SOCIAL_GITHUB_URL = "https://github.com/CodetruAutomation/CitizensAgentPortalAutomation.git";
