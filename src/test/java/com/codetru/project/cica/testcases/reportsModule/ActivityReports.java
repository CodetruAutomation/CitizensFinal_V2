...
public class ActivityReports extends BaseTest {

	@Parameters({ "ROW_NUMBER" })
	@Test
	public void TC_ActivityReports(String rowNumber) throws Exception {
...
//		getLoginPage().loginSuccessWithAgentAccount(excel.getCellData(rowNum, "userid"),excel.getCellData(rowNum, "password"));
		...
		getHomePage_Payments().Open_activityReports();
		getActivityReports().activityReports();
	}
